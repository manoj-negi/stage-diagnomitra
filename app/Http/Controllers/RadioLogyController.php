...
class RadioLogyController extends Controller
{
    ...
    //             if(Auth::user()->roles->contains(1)){
    //             $data = '';
    //             $data .= '<a href="'.route('radiology.edit', $row->id).'?url=radiology" class="btn btn-primary btn-sm mr-1">
    //                 <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
    //             </a>';

    //             $data .= '<form action="'.route('radiology.destroy',$row->id).'" method="POST" style="display: inline-block;">
    ...
    //                 $data = '';
    //             $data .= '<a href="'.route('radiology.edit', $row->id).'" class="btn btn-primary btn-sm">
    //                 <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
    //             </a>';
    ...
    // }
    return view('admin.radiology.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view('admin.radiology.create', $result);
    }
    ...
    public function store(Request $request)
{
    ...
    {  
        ...
        return view('admin.radiology.show', $data,$get)->with('HospitalDoctor', $asd);;
    }

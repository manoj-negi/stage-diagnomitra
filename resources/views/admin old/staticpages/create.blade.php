    ...
    <div class="row justify-content">
            ...
            <div class="card">
                ...
                <form action="{{route('static-pages.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <h4><b>Title</b></h2>
                    <input type="text" name="title" value="{{ old('title', isset($datas) && isset($datas->title) ? $datas->title : '') }}" class="form-control" />
                    </div>
                    @error('title')
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                        <label>Content</label>
                            <textarea name="content" class="form-control">{{ old('content', isset($dataresult) && isset($dataresult->content) ? $dataresult->content : '') }}</textarea>
                        </div>
                        @error('content')
                        <div class="validationclass text-danger pt-2">{{$message}}</div>
                        @enderror

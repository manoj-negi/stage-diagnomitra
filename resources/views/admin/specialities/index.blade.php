...
<div class="row">
    <div class="col-md-12 text-right">
        <a class="btn btn-primary btn-sm my-3" href="{{route('specialities.create')}}">Create</a>
            ...
            <div class="col-md-12">
                    ...
                    <div class="paging-section justify-content-end">
                     <form class="index-form">
                            <div class="search_bar d-flex">
                                ...
                                <a class="form-control src-btn" href="{{route('specialities.index')}}"><i class="fa fa-rotate-left"></i></a>
                            </div>
                        </form>
                    </div>
                    </div>
                ...
                <table class="table table-responsive tabel-hover">
                    ...
                    <tr>
                        ...
                        <td style="width: 5% !important;">{{ $data->firstItem() + $key ??''}}</td>
                        ...
                        <td><a href="{{route('specialities.edit',$result->id)}}" class="btn btn-primary btn-sm"><i
                                    class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                            <form action="{{route('specialities.destroy',$result->id)}}" method="post"

...
<div class="row pb-2">
    <div class="col-md-12 text-right">
        <a class="btn btn-primary btn-sm my-3" href="{{route('doctor-recommended.create')}}">Create</a>
            ...
            <div class="col-md-12">
                ...
                <table class="table table-responsive tabel-hover">
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('doctor-recommended.edit',$result->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        <form action="{{route('doctor-recommended.destroy',$result->id)}}" method="post" style="display: inline-block;">
                        @csrf
                        @method('delete')

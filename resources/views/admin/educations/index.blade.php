...
<div class="row pb-2">
    <div class="col-md-12 text-right">
        <a class="btn btn-primary btn-sm my-3" href="{{route('educations.create')}}">Create</a>
            ...
            <div class="col-md-12">
                    ...
                    <div class="paging-section justify-content-end">
                     <form class="index-form">
                            <div class="search_bar d-flex">
                                ...
                                <a class="form-control src-btn" href="{{route('educations.index')}}"><i class="fa fa-rotate-left"></i></a>
                            </div>
                        </form>
                    </div>
                    </div>
                ...
                <table class="table table-responsive tabel-hover">
                    ...
                    <tr>
                        ...
                        <td> @if(strlen($result->description)>=20)
                        ...
                        <td><a href="{{route('educations.edit',$result->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                        <form action="{{route('educations.destroy',$result->id)}}" method="post" style="display: inline-block;">
                        @csrf
                        @method('delete')

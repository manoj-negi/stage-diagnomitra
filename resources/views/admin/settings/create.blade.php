                    ...
                    <form action="{{route('site-settings.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ old('play_store_url', isset($updates) && isset($updates['play_store_url']) ? $updates['play_store_url'] : '') }}" name="play_store_url" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" value="{{ old('app_store_url', isset($updates) && isset($updates['app_store_url']) ? $updates['app_store_url'] : '') }}" name="app_store_url" class="form-control">
                                @error('app_store_url')
                                    <div class="alert text-danger">{{$message}}</div>
                                     @enderror
                            </div>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-6">
                                ...
                                <input type="number" value="{{ old('admin_commission', isset($updates) && isset($updates['admin_commission']) ? $updates['admin_commission'] : '')}}" name="admin_commission" class="form-control">
                                @error('name')
                                <div class="alert text-danger">{{$message}}</div>
                                @enderror
                            </div></div>

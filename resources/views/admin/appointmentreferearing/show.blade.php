        ...
        <div class="card">
            <div class="col-md-12">
                ...
                <table class="table table tabel-hover">
                    ...
                    @forelse($refer as $key=> $result)
                    <tr>
                    <td>{{$refer->firstItem() + $key ??''}}</td>
                            <td>{{isset($result->appointment->patient->name) ? $result->appointment->patient->name : '-' }}</td>
                            <td>{{$result->refer_code ??'-'}}</td>
            ...
            <div id="pagination">{{{ $refer->links() }}}</div>
        </div>
    </div>
</div>
<script>

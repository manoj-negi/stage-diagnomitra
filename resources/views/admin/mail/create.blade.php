            ...
            <div class="card">
                ...
                <form action="{{route('mail.store')}}" method="post" enctype="multipart/form-data">
                    ...
                    <select class="form-control" name="mail_key">
                        ...
                        <option value="consult-report" {{isset($result) && $result->mail_key=="consult-report"?"selected":''}}>Consult Report</option>
                        <option value="consult-certificate" {{isset($result) && $result->mail_key=="consult-certificate"?"selected":''}}>Consult Certificate</option>
                    </select></br>
                    @error('mail_key')
                    <div class="validationclass text-danger">{{$message}}</div>
                    @enderror

...
<div class="container">
    <div class="row pb-2">
        <div class="col-md-12 text-right">
            <a class="btn btn-primary btn-sm my-3" href="{{route('city.create')}}">Create</a>
            ...
            <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="paging-section justify-content-start">
                                    <select style="width:75px; margin-left: 10px;" class="form-select form-select"
                                        name="pagination" id="itemsPerPage" onchange="this.form.submit()">
                                        @foreach($paginateData as $page)
                                        <option value="{{ $page }}" {{ request()->get('pagination') == $page ?
                            ...
                            <div class="col-md-6 ">
                                <div class="paging-section justify-content-end">
                                    ...
                                    <div class="search_bar d-flex">
                                        ...
                                        <a class="form-control src-btn" href="{{route('city.index')}}"><i
                ...
                <table class="table table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('city.edit',$result->id)}}" class="btn btn-primary btn-sm"><i

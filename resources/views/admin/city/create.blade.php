                    ...
                    <form action="{{route('city.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="basic-default-fullname">City Name <span class="text-danger">*</span></label>
                                        <input type="text" name="city" class="form-control" value="{{ old('city', isset($data) && isset($data->city) ? $data->city : '') }}" placeholder="City Name" required/>
                                    </div>
                                    @error('city')
